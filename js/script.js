...
fetch("./api/projects.json")
    ...
    .then(projects => {
        ...
        const filters = ["All", ...new Set([...categories, ...tags])];
...
function displayProjects(projects){
    ...
    projectGrid.innerHTML = projectPagination.map(project => `
        <div class="project-card">
            <img loading="lazy" src="${project.image}" alt="${project.title} project screenshot">
            ...
            <div class="overlay">
                ...
                <a href="${project.overviewLink}" class="visit-link" title="Project overview" target="_blank">
        ...
        btn.addEventListener("click", () => {
            ...
            if (currentCategory === "All"){
                ...
                const filtered = projects.filter(
                    project => project.category === currentCategory || project.tags.includes(currentCategory)
                );
...
function animateFilter(projects, selected) {
    ...
    setTimeout(() => {
        ...
        if (selected === "All") {
            ...
            filteredProjects = projects.filter(project => project.category === selected || project.tags.includes(selected));
        }
